...
<body>
    <main class="flex-shrink-0">
        ...
        <form action="{{ route('halamanNews') }}" method="GET" class="mb-3">
            <div class="input-group">
                <input class="form-control me-2" type="text" placeholder="Search" name="cari" value="{{ $request->cari }}" class="form-control" aria-label="Search">
